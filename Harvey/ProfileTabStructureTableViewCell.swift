...
//
//        structureImageView = UIImageView(frame: CGRect(x: 0, y: 0, width: cellContainer.frame.width, height: cellContainer.frame.width))
...
//
//        border1.frame = CGRect(x: 0, y: cellContainer.frame.height - 1, width: cellContainer.frame.width, height: 1)
